...
export class InvitationTerritoryValidatorService {
  ...
  async validateInvitationTerritories(params: ValidateInvitationTerritoriesParams): Promise<void> {
  ...
  private async validateManagerInvitation(params: { managerTerritoryId?: string }): Promise<void> {
