...
describe('InviteUserUseCase', () => {
  ...
  describe('existing invite check', () => {
    ...
    it('should check for existing invite by email', async () => {
      ...
      expect(mockInviteRepository.findByEmailOrPhone).toHaveBeenCalledWith(email, undefined)
    })
    ...
    it('should check for existing invite by phone number', async () => {
      ...
      expect(mockInviteRepository.findByEmailOrPhone).toHaveBeenCalledWith(undefined, phoneNumber)
    })
