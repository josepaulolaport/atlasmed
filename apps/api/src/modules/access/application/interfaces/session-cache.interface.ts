...
export interface ISessionCache {
  ...
  getSupersededSession(tokenHash: string): Promise<SupersededRefreshTokenInfo | null>
  ...
  updateAfterRefresh(session: CachedSession, previousRefreshTokenHash: string): Promise<void>
