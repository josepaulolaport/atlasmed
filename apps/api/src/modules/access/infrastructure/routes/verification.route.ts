  ...
  .post(
    ...
    },
    {
      detail: {
        ...
        description:
          'Request to change email address. A verification link will be sent to the new email.',
        tags: ['Users']
      },
      body: t.Object({
  ...
  .post(
    ...
    },
    {
      detail: {
        ...
        description:
          'Request to change phone number. A verification code will be sent to the new number.',
        tags: ['Users']
      },
      body: t.Object({
