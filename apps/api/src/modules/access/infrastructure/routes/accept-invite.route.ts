  ...
  .post(
    ...
    },
    {
      detail: {
        ...
        description:
          'Register a new account using an invite token. Email must match where the invite was sent. If invited via phone, provide both phone and email.',
        tags: ['Authentication']
      },
      body: t.Object({
        ...
        phoneNumber: t.Optional(
          t.String({ description: 'User phone number (required if invited via phone)' })
        ),
