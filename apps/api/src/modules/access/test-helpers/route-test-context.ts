...
export const routeTestContext = {
  ...
  mocks: {
    ...
    updateProfileExecute: mock(async (_params?: unknown) => Promise.resolve(routeTestContext.user)),
...
export function scopedManagerContext(input: {
  ...
  return withTerritoryScopeAliases({
    ...
    isOperationallyActive: input.isOperationallyActive ?? input.territoryIds.length > 0,
