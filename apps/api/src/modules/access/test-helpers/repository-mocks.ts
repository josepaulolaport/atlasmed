...
export function createMockScopeRepository(
  ...
  return {
    ...
    replaceAssignments: mock(() => Promise.resolve()),
...
export function createMockInviteRepository(
  ...
  return {
    ...
    findStagedVerticalAssignments: mock(() => Promise.resolve([])),
    updatePending: mock(() => Promise.resolve({} as any)),
...
export function createMockSessionRepository(
  ...
  return {
    ...
    findActiveByPreviousRefreshTokenHash: mock(() => Promise.resolve(null)),
    findById: mock(() => Promise.resolve(null)),
...
export function createMockUserRepository(
  ...
  return {
    ...
    updateAsAdmin: mock(() => Promise.resolve({} as any)),
