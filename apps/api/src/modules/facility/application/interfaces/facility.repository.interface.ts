...
export interface FacilityRepository {
  ...
  findByExternalId(sourceProvider: string, externalSourceId: string): Promise<FacilityRecord | null>

  findSourceTrackedByProvider(sourceProvider: string): Promise<FacilityRecord[]>

  create(data: { name: string; lat?: number | null; lng?: number | null }): Promise<FacilityRecord>
