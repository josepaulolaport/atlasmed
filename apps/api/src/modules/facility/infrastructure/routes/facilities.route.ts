...
const listFacilitiesRoute = new Elysia()
  ...
  .get(
    ...
    },
    {
      detail: {
        summary:
          'List clinics (coordinates exclude facilities without location; results are ordered by distance)',
        tags: ['Clinics'],
        security: [{ bearerAuth: [] }]
      },
      query: t.Object({
  ...
  .patch(
    ...
    },
    {
      ...
      body: t.Object({
        ...
        relationshipLevel: t.Optional(t.Union([t.Number({ minimum: 1, maximum: 10 }), t.Null()])),
