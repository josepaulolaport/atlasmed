...
export const ROUTE_SECURITY_MANIFEST: Record<string, RouteSecurityLevel> = {
  ...
  "modules/facility/infrastructure/routes/cnes-facility-import.route.ts": "auth+permission",
  "modules/facility/infrastructure/routes/facilities.route.ts": "auth+permission",
  "modules/facility/infrastructure/routes/facility-geocoding.route.ts": "auth+permission",
  ...
  "modules/schedules/infrastructure/routes/schedules.route.ts": "auth+permission",
