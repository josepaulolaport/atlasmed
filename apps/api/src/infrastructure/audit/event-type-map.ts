...
const routeMap: Record<RouteKey, EventEntry> = {
  ...
  'POST /api/v1/auth/password-reset': {
    eventType: 'USER.PASSWORD_RESET_REQUEST',
    severity: 'WARNING'
  },
  'POST /api/v1/auth/password-reset/confirm': {
    eventType: 'USER.PASSWORD_RESET_COMPLETE',
    severity: 'WARNING'
  },
  ...
  'DELETE /api/v1/users/:id/permissions/:permissionId': {
    eventType: 'USER.PERMISSION_REVOKE',
    severity: 'WARNING'
  },
  ...
  'PUT /api/v1/facilities/:id/professionals/:professionalId': {
    eventType: 'FACILITY.PROFESSIONAL_UPDATED'
  },
  'DELETE /api/v1/facilities/:id/professionals/:professionalId': {
    eventType: 'FACILITY.PROFESSIONAL_UNLINKED'
  },
  ...
  'DELETE /api/v1/professionals/:id': {
    eventType: 'PROFESSIONAL.DEACTIVATED',
    severity: 'WARNING'
  },
  ...
  'PUT /api/v1/territories/:id/boundary': {
    eventType: 'TERRITORY.BOUNDARY_SET',
    severity: 'WARNING'
  },
  ...
  'DELETE /api/v1/catalog/products/:id': {
    eventType: 'CATALOG.PRODUCT_DEACTIVATED',
    severity: 'WARNING'
  }
}
...
export function resolveAuditEvent(method: string, path: string): EventEntry | null {
