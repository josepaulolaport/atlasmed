 ...
 */
function getOrCreateObservation(request: Request, requestIdHeader?: string): RequestObservation {
 ...
 */
function applySpanAttributes(observation: RequestObservation, statusCode?: number): void {
