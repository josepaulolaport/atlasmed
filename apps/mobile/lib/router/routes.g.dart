...
RouteBase get $newOrderRoute => GoRouteData.$route(
  path: '/orders/new',
  hasOverriddenOnExit: false,
  parentNavigatorKey: NewOrderRoute.$parentNavigatorKey,
  factory: $NewOrderRoute._fromState,
  routes: [
    GoRouteData.$route(
      path: 'cart',
      hasOverriddenOnExit: false,
      parentNavigatorKey: NewOrderCartRoute.$parentNavigatorKey,
      factory: $NewOrderCartRoute._fromState,
    ),
    GoRouteData.$route(
      path: 'checkout',
      hasOverriddenOnExit: false,
      parentNavigatorKey: NewOrderCheckoutRoute.$parentNavigatorKey,
      factory: $NewOrderCheckoutRoute._fromState,
    ),
    GoRouteData.$route(
      path: 'success',
      hasOverriddenOnExit: false,
      parentNavigatorKey: NewOrderSuccessRoute.$parentNavigatorKey,
      factory: $NewOrderSuccessRoute._fromState,
    ),
  ],
);

mixin $NewOrderRoute on GoRouteData {
  static NewOrderRoute _fromState(GoRouterState state) => NewOrderRoute(
    interactionId: _$convertMapValue(
      'interactionId',
      state.uri.queryParameters,
      int.tryParse,
    ),
  ...
  NewOrderRoute get _self => this as NewOrderRoute;

  @override
  String get location => GoRouteData.$location(
    '/orders/new',
    queryParams: {
      if (_self.interactionId != null)
        'interactionId': _self.interactionId!.toString(),
      if (_self.facilityId != null) 'facilityId': _self.facilityId!.toString(),
      if (_self.facilityName != null) 'facilityName': _self.facilityName,
    },
  );
...
mixin $NewOrderCartRoute on GoRouteData {
  static NewOrderCartRoute _fromState(GoRouterState state) =>
      const NewOrderCartRoute();

  @override
  String get location => GoRouteData.$location('/orders/new/cart');
...
mixin $NewOrderCheckoutRoute on GoRouteData {
  static NewOrderCheckoutRoute _fromState(GoRouterState state) =>
      const NewOrderCheckoutRoute();

  @override
  String get location => GoRouteData.$location('/orders/new/checkout');
...
mixin $NewOrderSuccessRoute on GoRouteData {
  static NewOrderSuccessRoute _fromState(GoRouterState state) =>
      NewOrderSuccessRoute($extra: state.extra as ApiOrderDetail?);

  NewOrderSuccessRoute get _self => this as NewOrderSuccessRoute;

  @override
  String get location => GoRouteData.$location('/orders/new/success');
