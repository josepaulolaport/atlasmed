...
final _clinicDetails = [
  ClinicDetail(
    ...
    avgPurchaseDays: 45,
    fieldNotes:
        'Dr. Carlos solicita visita mensal. Portaria exige agendamento com 48h de antecedência. Preferência por entregas na terça-feira pela manhã.',
    ...
    signals: [
      ClinicSignal(
        type: 'warning',
        message: 'Faturamento caiu 15% no último trimestre',
      ),
      ClinicSignal(
        type: 'info',
        message: 'Novo médico contratado: Dr. Ricardo Lopes (Cardiologista)',
      ),
    ],
    productPerformance: [
      ProductPerformance(
    ...
    visits: [
      ClinicVisit(
        ...
        type: 'visita',
        summary:
            'Apresentação do AtlasSpray. Dr. Carlos interessado. Agendado pedido experimental.',
        consultantName: 'Rafael Melo',
      ...
      ClinicVisit(
        ...
        type: 'entrega',
        summary:
            'Entrega de 50 unidades AtlasGel. Recebido por Maria (almoxarifado).',
        consultantName: 'Rafael Melo',
      ),
      ClinicVisit(
        ...
        type: 'visita',
        summary:
            'Revisão de estoque. Renovação de contrato anual. Inclusão de AtlasSpray.',
        consultantName: 'Rafael Melo',
      ),
      ClinicVisit(
        ...
        type: 'retorno',
        summary:
            'Devolução de 5 unidades AtlasCaps (lote vencido). Crédito concedido.',
        consultantName: 'Rafael Melo',
      ),
    ],
    clinicDoctors: [
  ...
  ClinicDetail(
    ...
    avgPurchaseDays: 60,
    fieldNotes:
        'Preferência por contato via WhatsApp. Dra. Marina é a prescritora principal. Clínica fecha para almoço 12h-14h.',
    ...
    signals: [
      ClinicSignal(
        type: 'success',
        message: 'Meta de prescrições atingida 3 meses consecutivos',
      ),
    ],
    productPerformance: [
      ProductPerformance(
    ...
    visits: [
      ClinicVisit(
        ...
        type: 'visita',
        summary:
            'Renovação de estoque AtlasGel. Dra. Marina satisfeita com resultados.',
        consultantName: 'Rafael Melo',
      ),
      ClinicVisit(
...
final _doctorDetails = [
  DoctorDetail(
    ...
    signals: [
      DoctorSignal(
        kind: 'good',
        title: 'Crescimento na prescrição de AtlasGel',
        body: '+32% nos últimos 90 dias. Reforçar com material de evidências.',
      ),
      DoctorSignal(
        kind: 'info',
        title: 'Aniversário em 22 de março',
        body: 'Enviar mensagem e brinde personalizado.',
      ),
      DoctorSignal(
        kind: 'warn',
        title: 'Preferência por contato por e-mail',
        body: 'Não atende ligações durante consultas.',
      ),
    ],
    prescribing: [
    ...
    visits: [
      DoctorVisit(
        ...
        note:
            'Apresentei novo material de suporte clínico para AtlasGel. Muito receptiva — pediu amostras para 10 pacientes. Interessada em participar de estudo.',
        outcome: 'positivo',
        samples: ['AtlasGel 240g · 10un'],
      ),
      DoctorVisit(
        date: '12/mai · ter',
        time: '14h00',
        ...
        location: 'Hospital São Lucas',
        note:
            'Fechou pedido de R\$ 5.800. Satisfeita com os resultados do AtlasGel nos pacientes.',
        outcome: 'positivo',
        orderValue: 'R\$ 5.800',
      ),
      DoctorVisit(
        ...
        consultantHue: 220,
        consultantInitials: 'RM',
        kind: 'Follow-up congresso',
        location: 'Hospital Samaritano',
        note:
            'Follow-up do SOCESP 2025. Comentou sobre novo artigo de cardiologia preventiva. Sugeri trial do CardioFlex.',
        outcome: 'misto',
        samples: ['CardioFlex · trial'],
      ),
      DoctorVisit(
        date: '08/mar · sex',
        time: '11h15',
        ...
        location: 'Hospital São Lucas',
        note:
            'Passou rapidamente no consultório. Confirmou presença no jantar de final de ano.',
        outcome: 'neutro',
      ),
    ],
    notes: [
  ...
  DoctorDetail(
    ...
    signals: [
      DoctorSignal(
        kind: 'good',
        title: 'Fidelidade AtlasMed',
        body:
            'Prescreve exclusivamente nossos produtos há 3 anos. Renovar parceria.',
      ),
      DoctorSignal(
        kind: 'info',
        title: 'Maratona em 60 dias',
        body: 'Treinando para a Maratona de SP. Enviar kit de hidratação.',
      ),
    ],
    prescribing: [
      DoctorPrescribingItem(
    ...
    visits: [
      DoctorVisit(
        ...
        location: 'Hospital Samaritano',
        note:
            'Rotina mensal. Renovação de estoque AtlasGel. Mencionou interesse em trial de nova formulação.',
        outcome: 'positivo',
      ...
      DoctorVisit(
        ...
        consultantHue: 220,
        consultantInitials: 'RM',
        kind: 'Entrega de amostras',
        location: 'Hospital Samaritano',
        note: 'Entrega de amostras solicitadas no mês anterior.',
        outcome: 'positivo',
        samples: ['AtlasGel 240g · 8un', 'NeuroFlex · trial'],
      ),
      DoctorVisit(
        date: '18/abr · qua',
        time: '10h00',
        ...
        consultantHue: 220,
        consultantInitials: 'RM',
        kind: 'Almoço de negócios',
        location: 'Restaurante Dona Firmina',
        note:
            'Almoço de alinhamento estratégico. Discutimos plano anual e metas de prescrição.',
        outcome: 'positivo',
      ),
    ],
    notes: [
  ...
  DoctorDetail(
    ...
    signals: [
      DoctorSignal(
        kind: 'good',
        title: 'Novo prescritor de AtlasDerm',
        body: 'Iniciou prescrição há 60 dias. Crescimento promissor.',
      ),
      DoctorSignal(
        kind: 'info',
        title: 'Aniversário em 30/11',
        body: ' Preparar brinde personalizado. Fã de futebol.',
      ),
      DoctorSignal(
        kind: 'warn',
        title: 'Restrição de visitas às quintas',
        body: 'Atende em outra clínica. Preferência por terças ou sextas.',
      ),
    ],
    prescribing: [
      DoctorPrescribingItem(
    ...
    visits: [
      DoctorVisit(
        ...
        consultantHue: 220,
        consultantInitials: 'RM',
        kind: 'Visita pedagógica',
        location: 'Centro Médico Albert Einstein',
        note:
            'Apresentei resultados de estudo pediátrico do AtlasGel. Muito interessado — pediu literatura para compartilhar com colegas.',
        outcome: 'positivo',
        samples: ['AtlasGel 120g · 8un'],
      ),
      DoctorVisit(
        date: '08/mai · sex',
        time: '11h30',
        ...
        location: 'Centro Médico Albert Einstein',
        note:
            'Rápido follow-up. Confirmou que AtlasDerm está funcionando bem. Solicitou mais material.',
        outcome: 'positivo',
        samples: ['AtlasDerm · 5un'],
      ),
    ],
    notes: [
