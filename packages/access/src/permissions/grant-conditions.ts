...
const SCOPED_SUBJECTS = new Set<Subject>(['USER', 'FACILITY', 'PROFESSIONAL', 'TERRITORY'])
...
export function buildCaslConditionsFromGrant(
  ...
  if (grant.resourceId && typeof conditions.id === 'string' && conditions.id !== grant.resourceId) {
