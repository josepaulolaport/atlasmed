...
import { type Action, defineAbilitiesFor, type Subject } from './role.permissions'
...
export function canAccessResource(
  ...
  return canOnResource(defineAbilitiesForUser(role, grants), action, subjectType, resourceId)
}
