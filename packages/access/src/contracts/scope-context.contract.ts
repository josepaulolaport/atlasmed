...
export function withTerritoryScopeAliases(
  ...
  const analyticsFacilityIds = scope.analyticsFacilityIds ?? scope.analyticsClinicIds ?? facilityIds
  return {
    ...scope,
    effectiveTerritoryIds,
    analyticsEffectiveTerritoryIds: scope.analyticsEffectiveTerritoryIds ?? effectiveTerritoryIds,
