...
export const createFacilitySchema = z.object({
  ...
  legalDocumentType: z.enum(["CNPJ", "CPF"]).optional(),
  legalDocument: z.string().trim().max(18).optional(),
...
export const updateFacilitySchema = z.object({
  ...
  legalDocumentType: z.enum(["CNPJ", "CPF"]).optional().nullable(),
  legalDocument: z.string().trim().max(18).optional().nullable(),
