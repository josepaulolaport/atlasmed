...
import type { DirectionsParams, DirectionsResponse } from '../types/directions'
import type {
...
import type { IsochroneParams, IsochroneResponse } from '../types/isochrone'
import type { MapMatchingParams, MapMatchingResponse } from '../types/map-matching'
import type { MatrixParams, MatrixResponse } from '../types/matrix'
import type { OptimizationParams, OptimizationResponse } from '../types/optimization'
import type {
...
import type { StaticImageParams, TilequeryParams, TilequeryResponse } from '../types/static-images'
