CREATE TYPE "public"."interaction_type" AS ENUM('followup', 'presentation');--> statement-breakpoint
ALTER TABLE "visits" RENAME TO "interactions";--> statement-breakpoint
ALTER TABLE "interactions" RENAME COLUMN "visited_at" TO "interacted_at";--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "interactions" DROP CONSTRAINT "visits_user_id_users_id_fk";
--> statement-breakpoint
ALTER TABLE "interactions" DROP CONSTRAINT "visits_facility_id_facilities_id_fk";
--> statement-breakpoint
...
DROP INDEX "visits_user_id_visited_at_idx";--> statement-breakpoint
DROP INDEX "visits_facility_id_visited_at_idx";--> statement-breakpoint
...
ALTER TABLE "interactions" ADD COLUMN "type" "interaction_type" NOT NULL;--> statement-breakpoint
ALTER TABLE "interactions" ADD COLUMN "summary" text NOT NULL;--> statement-breakpoint
...
ALTER TABLE "orders" ADD CONSTRAINT "orders_interaction_id_interactions_id_fk" FOREIGN KEY ("interaction_id") REFERENCES "public"."interactions"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "interactions_user_id_interacted_at_idx" ON "interactions" USING btree ("user_id","interacted_at");--> statement-breakpoint
CREATE INDEX "interactions_facility_id_interacted_at_idx" ON "interactions" USING btree ("facility_id","interacted_at");--> statement-breakpoint
