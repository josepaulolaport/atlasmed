...
-- Fact→lookup FKs deferred until CNES catalogs are seeded (empty lookups break
-- deploy when facilities.facility_type_code / similar columns already have values).
