...
export const authSessionTypeEnum = pgEnum('auth_session_type', ['WEB', 'MOBILE', 'API'])
...
export const contactTypeEnum = pgEnum('contact_type', ['PROFESSIONAL', 'DECISOR', 'COMPRADOR'])
...
export const orderTypeEnum = pgEnum('order_type', ['SALE', 'CONSIGNMENT', 'DONATION', 'OTHER'])
