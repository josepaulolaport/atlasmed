...
4. Dermatologia catalog seed (`0027_seed_dermatologia`) after this addendum (Q7 A) — **done**. Still open: Derm zone/patch rows, membership recompute, user assigns, profiles/consultants.
